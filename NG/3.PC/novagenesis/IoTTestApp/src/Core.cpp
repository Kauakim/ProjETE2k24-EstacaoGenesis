	...
	: Block (_LN, _PP, _Index, _Path)
{
  ...
  ptemperatura=new OutputVariable(this);
  pumidade=new OutputVariable(this);
  ppressao=new OutputVariable(this);
  pradiacao_solar=new OutputVariable(this);
  puv=new OutputVariable(this);
  pvelocidade_vento=new OutputVariable(this);
  pinclinacao_vento=new OutputVariable(this);
  ppluv_count=new OutputVariable(this);
  pbutton_state=new OutputVariable(this);
  porv=new OutputVariable(this);

  // Setting the statistics variables
  ptemperatura->Initialization("temperatura","MEAN_ARITHMETIC","Temperatura em celsius",1);
  pumidade->Initialization("umidade","MEAN_ARITHMETIC","Umidade do ar",1);
  ppressao->Initialization("pressao","MEAN_ARITHMETIC","Pressao atmosferica",1);
  pradiacao_solar->Initialization("radiacao_solar","MEAN_ARITHMETIC","Radiacao solar",1);
  puv->Initialization("uv","MEAN_ARITHMETIC","Radiacao uv",1);
  pvelocidade_vento->Initialization("velocidade_vento","MEAN_ARITHMETIC","Velocidade do vento",1);
  pinclinacao_vento->Initialization("inclinacao_vento","MEAN_ARITHMETIC","Inclinacao_vento",1);
  ppluv_count->Initialization("pluv_count","MEAN_ARITHMETIC","Contador do pluviometro",1);
  pbutton_state->Initialization("button_state","MEAN_WEIGHTED","Sensor da porta",1);
  porv->Initialization("ponto de orvalho","MEAN_ARITHMETIC","Ponto de orvalho",1);
